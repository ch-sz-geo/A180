...
Die Auftrennung wünschte die zuständige kantonale Stelle, da die Daten zur Ökomorphologie laufend nachgeführt werden, wohingegen die Daten zur Revitalisierungsplanung alle zwölf Jahre erhoben werden und statisch bleiben.
